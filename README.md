...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 468,543 | 🐛 77 | 📅 2026-05-05.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,195 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 487 | 🐛 24 | 🌐 Java | 📅 2026-05-20 - Library/API for detection of refactorings in changes of Java code.
