...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 451,318 | 🐛 59 | 📅 2026-04-02.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 229 | 🐛 20 | 🌐 C++ | 📅 2026-04-02.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 479 | 🐛 24 | 🌐 Java | 📅 2026-04-03 - Library/API for detection of refactorings in changes of Java code.
