...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 458,030 | 🐛 67 | 📅 2026-04-19.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 231 | 🐛 10 | 🌐 C++ | 📅 2026-04-22.
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 951 | 🐛 15 | 🌐 Python | 📅 2025-12-28 - Python Framework to analyse Git repositories.
