...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 437,047 | 🐛 69 | 📅 2026-01-28.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,238 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 476 | 🐛 26 | 🌐 Java | 📅 2026-02-09 - Library/API for detection of refactorings in changes of Java code.
