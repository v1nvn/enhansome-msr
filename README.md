...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 453,684 | 🐛 61 | 📅 2026-04-02.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 231 | 🐛 16 | 🌐 C++ | 📅 2026-04-07.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 480 | 🐛 22 | 🌐 Java | 📅 2026-04-10 - Library/API for detection of refactorings in changes of Java code.
