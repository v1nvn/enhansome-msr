...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 452,320 | 🐛 60 | 📅 2026-04-02.
...
* [Defects4J](https://github.com/rjust/defects4j) ⭐ 949 | 🐛 55 | 🌐 Perl | 📅 2025-10-11 - Collection of 395 reproducible bugs collected with the goal of advancing software testing research.
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 230 | 🐛 13 | 🌐 C++ | 📅 2026-04-05.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 480 | 🐛 24 | 🌐 Java | 📅 2026-04-06 - Library/API for detection of refactorings in changes of Java code.
