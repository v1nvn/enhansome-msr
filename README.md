...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 437,260 | 🐛 69 | 📅 2026-01-28.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,239 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 222 | 🐛 16 | 🌐 C++ | 📅 2026-02-13.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 477 | 🐛 26 | 🌐 Java | 📅 2026-02-09 - Library/API for detection of refactorings in changes of Java code.
