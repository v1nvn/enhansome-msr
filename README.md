...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 469,485 | 🐛 76 | 📅 2026-05-05.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,198 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 956 | 🐛 15 | 🌐 Python | 📅 2025-12-28 - Python Framework to analyse Git repositories.
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 487 | 🐛 24 | 🌐 Java | 📅 2026-05-23 - Library/API for detection of refactorings in changes of Java code.
* [Perceval](https://github.com/chaoss/grimoirelab-perceval) ⭐ 320 | 🐛 40 | 🌐 Python | 📅 2026-05-22 - Fetch repository data from tens of back-ends.
