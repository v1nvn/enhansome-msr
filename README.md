...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 473,282 | 🐛 83 | 📅 2026-06-02.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,217 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 229 | 🐛 11 | 🌐 C++ | 📅 2026-05-28.
...
* [PyDriller](https://github.com/ishepard/pydriller) ⭐ 960 | 🐛 15 | 🌐 Python | 📅 2025-12-28 - Python Framework to analyse Git repositories.
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 490 | 🐛 26 | 🌐 Java | 📅 2026-06-05 - Library/API for detection of refactorings in changes of Java code.
* [Perceval](https://github.com/chaoss/grimoirelab-perceval) ⭐ 321 | 🐛 40 | 🌐 Python | 📅 2026-06-02 - Fetch repository data from tens of back-ends.
