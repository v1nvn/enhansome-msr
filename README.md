...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 471,888 | 🐛 83 | 📅 2026-05-05.
...
* [Unix history](https://github.com/dspinellis/unix-history-repo) ⭐ 7,214 | 🐛 0 | 🌐 Assembly | 📅 2026-01-05 - Git repository with 46 years of Unix history evolution.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 488 | 🐛 24 | 🌐 Java | 📅 2026-05-31 - Library/API for detection of refactorings in changes of Java code.
