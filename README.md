...
* For more awesome lists, see [awesome](https://github.com/sindresorhus/awesome) ⭐ 447,390 | 🐛 88 | 📅 2026-03-09.
...
* [Linux Kernel 4.21 Call Graphs](https://zenodo.org/record/2652487#.XRnvomUzb0o) - The Linux Kernel 4.21 Call Graphs produced using [CScout](https://github.com/dspinellis/cscout/) ⭐ 228 | 🐛 22 | 🌐 C++ | 📅 2026-03-17.
...
* [RefactoringMiner](https://github.com/tsantalis/RefactoringMiner) ⭐ 480 | 🐛 23 | 🌐 Java | 📅 2026-03-20 - Library/API for detection of refactorings in changes of Java code.
